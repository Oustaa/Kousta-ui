...
<DocHeader
  description="Read and write nested object properties from a string path — the utility that lets headers and select options be configured with keys like location.address."
  pkg="@kousta-ui/helpers"
  exports="getNestedProperty, updateNestedProperties"
