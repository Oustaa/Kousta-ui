...
<DocHeader
  description="Four small React hooks with no dependencies — the stateful bits the library needed often enough to extract. Useful on their own, with or without the rest of Kousta UI."
  pkg="@kousta-ui/hooks"
  exports="useDisclosure, useScrollLock, usePagination, useDebounceCallback"
...
- Check out [Components package](/docs/Components/overview)
- Explore [Table package](/docs/Table/Table)
